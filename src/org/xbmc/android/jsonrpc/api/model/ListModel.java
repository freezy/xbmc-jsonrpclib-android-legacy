...
public final class ListModel {
	...
	public static class Limits extends AbstractModel {
		...
		// class members
		/**
		 * The number of items in the list being returned.
		 */
		 ...
		 * @param end The number of items in the list being returned 
		 * @param start 
		 */
